...
var oAuth = new OAuth("http://dev.shelby.tv/oauth/request_token",
                 ...
                 "1.0", 'http://li364-176.members.linode.com/oauth/callback', "PLAINTEXT");

exports.consumer = function() {
    return new OAuth(
    "http://dev.shelby.tv/oauth/request_token", "http://dev.shelby.tv/oauth/access_token",
    shelbyConsumerKey, shelbyConsumerSecret, "1.0", "http://li364-176.members.linode.com/oauth/callback", "HMAC-SHA1");
}
